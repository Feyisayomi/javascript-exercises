...
// attribute prevented.
console.log("Testing the Devtool");
console.log(document.title);
// The defer attribute prevents the script from running before the HTML has been parsed.
// TODO: Part two.
...
heading.textContent = "Sayo Record Label";

const tagline = document.querySelector(".tagline");
tagline.textContent = "Afrobeats, world best Music";
...
const artists = [
  ...
  //New card added from part four
  { name: "Teni", genre: "Afropop", total: "13" },
];
const cardArea = document.querySelector(".cards");
//function for artist card
...
//artists.push({ name: "Teni", genre: "Afropop", total: "13" });
// I did not have to change the code and I do not have to manually hand-copy another card.
// TODO: Part five.
